import { Button, Label, Modal, Table, TextInput, Select } from 'flowbite-react';
      ...
      <div>
        ...
        <Table striped>
          <Table.Head>
            ...
            <Table.HeadCell>Truck Type</Table.HeadCell>
            <Table.HeadCell>Temperature</Table.HeadCell>
            <Table.HeadCell><span>Actions</span></Table.HeadCell>
          </Table.Head>
...
function MakeTableRow({name, data, handleEdit, handleDelete}) {
  return (
    <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
      ...
      <Table.Cell>{data?.truck_type_display ?? data?.truck_type}</Table.Cell>
      <Table.Cell>{data?.temperature_display ?? data?.temperature}</Table.Cell>
      <Table.Cell>
